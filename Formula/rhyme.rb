class Rhyme < Formula
  ...
  def install
    ...
    Dir.chdir("rhyme-0.9") do
      system "make", "BINPATH=#{HOMEBREW_PREFIX}/bin", "RHYMEPATH=#{HOMEBREW_PREFIX}/share/rhyme", "MANPATH=#{HOMEBREW_PREFIX}/share/man/man1", "INCLUDES=-I/usr/local/opt/readline/include/readline"
      bin.install "rhyme"
